	...
	var pagefunction = function() {
		...
		loadScript("js/jquery.flot.cust.min.js", function(){
			loadScript("js/jquery.flot.resize.min.js", function(){
				loadScript("js/jquery.flot.time.min.js", function(){
					loadScript("js/jquery.flot.tooltip.min.js", generatePageGraphs);
				});
			});
		});
		...
		loadScript("js/jquery-jvectormap-1.2.2.min.js", function(){
			loadScript("js/jquery-jvectormap-world-mill-en.js", renderVectorMap);
		});
		...
		loadScript("js/moment.min.js", function(){
			loadScript("js/jquery.fullcalendar.min.js", setupCalendar);
		});
